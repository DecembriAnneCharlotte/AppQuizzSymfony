...
import {checkOptions} from "./custom1"
...
function localStorageBackup() {
    ...
    if (localStorage.sashdarkPrimary) {
        if(document.getElementById('darkPrimaryColorID') != null){
    ...
    if (localStorage.sashtransparentPrimary) {
        if(document.getElementById('transparentPrimaryColorID') != null){
    ...
    if (localStorage.sashtransparentBgImgPrimary) {
        if(document.getElementById('transparentBgImgPrimaryColorID') != null){
    ...
    if (localStorage.sashtransparentBgColor) {
        if(document.getElementById('transparentBgColorID') != null){
...
export function names() {
    ...
    if(document.querySelector('#transactions') !== null){
        index(myVarVal, myVarVal1, hexToRgba);
    }
