$(function(e) {
 ...
 let flotback_char = document.getElementById('flotback-chart');
 if(flotback_char != null){
     // FLOAT CHART
     $.plot('#flotback-chart', [{
        data: dashData10,
    ...
    // LEADS CHART
    var ctx2 = document.getElementById('leadschart');
    if(ctx2 != null){
    ...
    // PROFIT CHART
    var ctx3 = document.getElementById('profitchart');
    if(ctx3 != null){
    ...
    // WORLD MAP MARKER
    let wordmapmarker1 = document.getElementById('world-map-markers1');
    if(wordmapmarker1 != null){
...
export function index(myVarVal, myVarVal1, hexToRgba) {
